...
isl_stat isl_options_set_schedule_outer_typed_fusion(isl_ctx *ctx, int val);
int isl_options_get_schedule_outer_typed_fusion(isl_ctx *ctx);
...
isl_stat isl_options_set_schedule_single_outer_coincidence(isl_ctx *ctx,
	int val);
int isl_options_get_schedule_single_outer_coincidence(isl_ctx *ctx);
...
isl_stat isl_options_set_schedule_spatial_fusion(isl_ctx *ctx, int val);
int isl_options_get_schedule_spatial_fusion(isl_ctx *ctx);
...
__isl_give isl_union_map *isl_schedule_constraints_get_proximity(
	__isl_keep isl_schedule_constraints *sc);
__isl_give isl_union_map *isl_schedule_constraints_get_fusion_proximity(
	__isl_keep isl_schedule_constraints *sc);
